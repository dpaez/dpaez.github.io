...
export const experienceData: Experience[] = [
  {
    ...
    period: '2018 - Present',
    description:
      'Boutique software consultancy and a lab for P2P experiments.',
    highlights: [
  ...
  },
  {
    ...
    period: '2022 - 2024',
    description:
      'Worked inside an established product team, moving fast across the stack—from developer tooling and bundling to shipping meaningful performance wins.',
    highlights: [
      'First staff-augmentation experience for GEUT',
      'Worked across the full stack from developer tooling to production performance',
  ...
  },
  {
    ...
    period: 'Previous Experience',
    description:
      'Assistant Professor at alma mater teaching "User Centered Design" and "Mobile Devices\' Interfaces".',
    highlights: [
